...
정상 실행 후 `curl`로 프록시 요청을 보낸 결과입니다.

![cproxy 실행 및 테스트 결과](docs/images/run-test-output.svg)

잘못된 실행 인자를 전달했을 때의 오류 출력입니다.

![cproxy 오류 출력 결과](docs/images/error-output.svg)
